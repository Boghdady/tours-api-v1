...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add marker for each location
...
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateMyAccount.js":[function(require,module,exports) {
"use strict";
...
var _updateMyAccount = require("./updateMyAccount");
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  (0, _updateMyAccount.updateUserData)({
    name: name,
    email: email
  }, 'data');
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return (0, _updateMyAccount.updateUserData)({
